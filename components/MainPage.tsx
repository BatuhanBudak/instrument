...
export default function MainPage() {
    ...
    return (
        <main>
            ...
            <div className='centered-container'>
                {windowWidth < desktopWidth && <Image src={eye} alt='eye illustration' /> }
                {windowWidth >= desktopWidth && <Image src={eye2} alt='eye illustration' /> }
            ...
            <div className='centered-container'>
                {windowWidth < desktopWidth && <Image src={cellphone} alt='cellphone' /> }
                {windowWidth >= desktopWidth && <Image src={cellphone2} alt='cellphone' /> }
            ...
            <div className='centered-container small-gap section-seperator '>
                ...
                <button className='btn our-work-btn'><a href="">Our work</a></button>
            </div>
            ...
            <div className='centered-container small-gap section-seperator '>
                ...
                <button className='btn our-work-btn '><a href="">Get in touch</a></button>
            </div>
        </main>
    )
}
